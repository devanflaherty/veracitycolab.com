...
exports.isiPad = exports.isiPhone = undefined;
...
var isiPad = exports.isiPad = function isiPad() {
...
if (isiPad()) {
  (0, _jquery2.default)('body').addClass('ipad');
}
...
var _foundationSites = __webpack_require__(12);
...
(function (e, t, r) {
  ...
  function n(r) {
    if (o = t.documentElement, a = t.body, K(), it = this, r = r || {}, ut = r.constants || {}, r.easing) for (var n in r.easing) {
      U[n] = r.easing[n];
    }yt = r.edgeStrategy || "set", ct = { beforerender: r.beforerender, render: r.render, keyframe: r.keyframe }, ft = r.forceHeight !== !1, ft && (Vt = r.scale || 1), mt = r.mobileDeceleration || x, dt = r.smoothScrolling !== !1, gt = r.smoothScrollingDuration || E, vt = { targetTop: it.getScrollTop() }, Gt = (r.mobileCheck || function () {
    ...
    return t.toUpperCase();
      ...
      G = "",
      K = function K() {
    var e = /^(?:O|Moz|webkit|ms)|(?:-(?:o|moz|webkit|ms)-)/;if (c) {
      var t = c(a, null);for (var n in t) {
        if (B = n.match(e) || +n == n && t[n].match(e)) break;
      }if (!B) return B = G = "", r;B = B[0], "-" === B.slice(0, 1) ? (G = B, B = { "-webkit-": "webkit", "-moz-": "Moz", "-ms-": "ms", "-o-": "O" }[B]) : G = "-" + B.toLowerCase() + "-";
    }
  },
      Y = function Y() {
    var t = e.requestAnimationFrame || e[B.toLowerCase() + "RequestAnimationFrame"],
        r = Pt();return (Gt || !t) && (t = function t(_t2) {
      var n = Pt() - r,
          o = s.max(0, 1e3 / 60 - n);return e.setTimeout(function () {
        r = Pt(), _t2();
      }, o);
    }), t;
  },
      R = function R() {
    var t = e.cancelAnimationFrame || e[B.toLowerCase() + "CancelAnimationFrame"];return (Gt || !t) && (t = function t(_t3) {
      return e.clearTimeout(_t3);
    }), t;
  },
      U = { begin: function begin() {
      return 0;
    }, end: function end() {
      return 1;
      ...
      var t;if (.5083 >= e) t = 3;else if (.8489 >= e) t = 9;else if (.96208 >= e) t = 27;else {
        if (!(.99981 >= e)) return 1;t = 91;
      }return 1 - s.abs(3 * s.cos(1.028 * e * t) / t);
    } };n.prototype.refresh = function (e) {
    var n,
        o,
        a = !1;for (e === r ? (a = !0, lt = [], Bt = 0, e = t.getElementsByTagName("*")) : e.length === r && (e = [e]), n = 0, o = e.length; o > n; n++) {
      var i = e[n],
          l = i,
          s = [],
          c = dt,
          f = yt,
          u = !1;if (a && H in i && delete i[H], i.attributes) {
        for (var m = 0, p = i.attributes.length; p > m; m++) {
          var g = i.attributes[m];if ("data-anchor-target" !== g.name) {
            if ("data-smooth-scrolling" !== g.name) {
              if ("data-edge-strategy" !== g.name) {
                if ("data-emit-events" !== g.name) {
                  var v = g.name.match(N);if (null !== v) {
                    var h = { props: g.value, element: i, eventType: g.name.replace(z, q) };s.push(h);var y = v[1];y && (h.constant = y.substr(1));var T = v[2];/p$/.test(T) ? (h.isPercentage = !0, h.offset = (0 | T.slice(0, -1)) / 100) : h.offset = 0 | T;var b = v[3],
                        S = v[4] || b;b && b !== A && b !== F ? (h.mode = "relative", h.anchors = [b, S]) : (h.mode = "absolute", b === F ? h.isEnd = !0 : h.isPercentage || (h.offset = h.offset * Vt));
                  }
                } else u = !0;
              } else f = g.value;
            } else c = "off" !== g.value;
          ...
          var k, w, x;!a && H in i ? (x = i[H], k = lt[x].styleAttr, w = lt[x].classAttr) : (x = i[H] = Bt++, k = i.style.cssText, w = Ct(i)), lt[x] = { element: i, styleAttr: k, classAttr: w, anchorTarget: l, keyFrames: s, smoothScrolling: c, edgeStrategy: f, emitEvents: u, lastFrameIndex: -1 }, Dt(i, [d], []);
        }
      }
    }for (Et(), n = 0, o = e.length; o > n; n++) {
      var E = lt[e[n][H]];E !== r && (J(E), et(E));
    }return it;
  }, n.prototype.relativeToAbsolute = function (e, t, r) {
    var n = o.clientHeight,
        a = e.getBoundingClientRect(),
        i = a.top,
        l = a.bottom - a.top;return t === D ? i -= n : t === C && (i -= n / 2), r === D ? i += l : r === C && (i += l / 2), i += it.getScrollTop(), 0 | i + .5;
  }, n.prototype.animateTo = function (e, t) {
    t = t || {};var n = Pt(),
        o = it.getScrollTop();return pt = { startTop: o, topDiff: e - o, targetTop: e, duration: t.duration || w, startTime: n, endTime: n + (t.duration || w), easing: U[t.easing || k], done: t.done }, pt.topDiff || (pt.done && pt.done.call(it, !1), pt = r), it;
    ...
    var e = R();e(bt), wt(), Dt(o, [T], [y, b, S]);for (var t = 0, n = lt.length; n > t; t++) {
      ot(lt[t].element);
    ...
    var n, i, l, c, d, g, v, h, y, T, b, S;St(o, [f, u, m, p].join(" "), function (e) {
      var o = e.changedTouches[0];for (c = e.target; 3 === c.nodeType;) {
        c = c.parentNode;
      }switch (d = o.clientY, g = o.clientX, T = e.timeStamp, I.test(c.tagName) || e.preventDefault(), e.type) {case f:
          n && n.blur(), it.stopAnimateTo(), n = c, i = v = d, l = g, y = T;break;case u:
          I.test(c.tagName) && t.activeElement !== c && e.preventDefault(), h = d - v, S = T - b, it.setScrollTop(Kt - h, !0), v = d, b = T;break;default:case m:case p:
          var a = i - d,
              k = l - g,
              w = k * k + a * a;if (49 > w) {
            if (!I.test(n.tagName)) {
              n.focus();var x = t.createEvent("MouseEvents");x.initMouseEvent("click", !0, !0, e.view, 1, o.screenX, o.screenY, o.clientX, o.clientY, e.ctrlKey, e.altKey, e.shiftKey, e.metaKey, 0, null), n.dispatchEvent(x);
            }return;
          }n = r;var E = h / S;E = s.max(s.min(E, 3), -3);var A = s.abs(E / mt),
              F = E * A + .5 * mt * A * A,
              C = it.getScrollTop() - F,
              D = 0;C > Ot ? (D = (Ot - C) / F, C = Ot) : 0 > C && (D = -C / F, C = 0), A *= 1 - D, it.animateTo(0 | C + .5, { easing: "outCubic", duration: A });}
    ...
    var e,
        ...
        m,
        p = o.clientHeight,
        d = At();for (c = 0, f = lt.length; f > c; c++) {
    ...
    for (var r = 0, n = lt.length; n > r; r++) {
      var o,
          ...
          S = T ? p : y,
          k = s.emitEvents,
          w = s.lastFrameIndex;if (T || b) {
        if (T && -1 === s.edge || b && 1 === s.edge) continue;switch (T ? (Dt(c, [g], [h, v]), k && w > -1 && (xt(c, p.eventType, zt), s.lastFrameIndex = -1)) : (Dt(c, [h], [g, v]), k && m > w && (xt(c, y.eventType, zt), s.lastFrameIndex = m)), s.edge = T ? -1 : 1, s.edgeStrategy) {case "reset":
            ot(c);continue;case "ease":
            f = S.frame;break;default:case "set":
            var x = S.props;for (o in x) {
              l.call(x, o) && (a = nt(x[o].value), 0 === o.indexOf("@") ? c.setAttribute(o.substr(1), a) : i.setStyle(c, o, a));
            }continue;}
      } else 0 !== s.edge && (Dt(c, [d, v], [g, h]), s.edge = 0);for (var E = 0; m - 1 > E; E++) {
        if (f >= u[E].frame && u[E + 1].frame >= f) {
          var A = u[E],
              F = u[E + 1];for (o in A.props) {
            if (l.call(A.props, o)) {
              var C = (f - A.frame) / (F.frame - A.frame);C = A.props[o].easing(C), a = rt(A.props[o].value, F.props[o].value, C), a = nt(a), 0 === o.indexOf("@") ? c.setAttribute(o.substr(1), a) : i.setStyle(c, o, a);
            }
          }k && w !== E && ("down" === zt ? xt(c, A.eventType, zt) : xt(c, F.eventType, zt), s.lastFrameIndex = E);break;
        }
      }
    }
  },
    ...
    _t && (_t = !1, Et());var e,
        t,
        n = it.getScrollTop(),
        o = Pt();if (pt) o >= pt.endTime ? (n = pt.targetTop, e = pt.done, pt = r) : (t = pt.easing((o - pt.startTime) / pt.duration), n = 0 | pt.startTop + t * pt.topDiff), it.setScrollTop(n, !0);else if (!ht) {
      var a = vt.targetTop - n;a && (vt = { startTop: qt, topDiff: n - qt, targetTop: n, startTime: Lt, endTime: Lt + gt }), vt.endTime >= o && (t = U.sqrt((o - vt.startTime) / gt), n = 0 | vt.startTop + t * vt.topDiff);
    }if (Gt && st && i.setStyle(st, "transform", "translate(0, " + -Kt + "px) " + Tt), ht || qt !== n) {
      zt = n > qt ? "down" : qt > n ? "up" : zt, ht = !1;var l = { curTop: n, lastTop: qt, maxTop: Ot, direction: zt },
          s = ct.beforerender && ct.beforerender.call(it, l);s !== !1 && (W(n, it.getScrollTop()), qt = n, ct.render && ct.render.call(it, l)), e && e.call(it, !1);
    }Lt = o;
  },
      J = function J(e) {
    for (var t = 0, r = e.keyFrames.length; r > t; t++) {
      for (var n, o, a, i, l = e.keyFrames[t], s = {}; null !== (i = O.exec(l.props));) {
        a = i[1], o = i[2], n = a.match(V), null !== n ? (a = n[1], n = n[2]) : n = k, o = o.indexOf("!") ? Q(o) : [o.slice(1)], s[a] = { value: o, easing: U[n] };
      }l.props = s;
    }
  },
      Q = function Q(e) {
    var t = [];return $.lastIndex = 0, e = e.replace($, function (e) {
    ...
    var t,
        r,
        n = {};for (t = 0, r = e.keyFrames.length; r > t; t++) {
      tt(e.keyFrames[t], n);
    ...
    var n,
        o = e.length;if (o !== t.length) throw "Can't interpolate between \"" + e[0] + '" and "' + t[0] + '"';var a = [e[0]];for (n = 1; o > n; n++) {
      a[n] = e[n] + (t[n] - e[n]) * r;
    }return a;
  },
      nt = function nt(e) {
    var t = 1;return M.lastIndex = 0, e[0].replace(M, function () {
      return e[t++];
    });
  },
      ot = function ot(e, t) {
    e = [].concat(e);for (var r, n, o = 0, a = e.length; a > o; o++) {
      ...
      at = function at() {
    Tt = "translateZ(0)", i.setStyle(st, "transform", Tt);var e = c(st),
        t = e.getPropertyValue("transform"),
        r = e.getPropertyValue(G + "transform"),
        n = t && "none" !== t || r && "none" !== r;n || (Tt = "");
  };i.setStyle = function (e, t, r) {
    var n = e.style;if (t = t.replace(z, q).replace("-", ""), "zIndex" === t) n[t] = isNaN(r) ? r : "" + (0 | r);else if ("float" === t) n.styleFloat = n.cssFloat = r;else try {
    ...
    };r = r.split(" ");for (var a, i = 0, l = r.length; l > i; i++) {
      a = r[i], t.addEventListener ? t.addEventListener(a, n, !1) : t.attachEvent("on" + a, o), Yt.push({ element: t, name: a, listener: n });
    }
  },
      kt = i.removeEvent = function (e, t, r) {
    t = t.split(" ");for (var n = 0, o = t.length; o > n; n++) {
    ...
    ct.keyframe && ct.keyframe.call(it, e, t, r);
      ...
      Et = function Et() {
    var e = it.getScrollTop();Ot = 0, ft && !Gt && (a.style.height = ""), j(), ft && !Gt && (a.style.height = Ot + o.clientHeight + "px"), Gt ? it.setScrollTop(s.min(it.getScrollTop(), Ot)) : it.setScrollTop(e, !0), ht = !0;
  },
      At = function At() {
    var e,
        t,
    ...
    var e = st && st.offsetHeight || 0,
        t = s.max(e, a.scrollHeight, a.offsetHeight, o.scrollHeight, o.offsetHeight, o.clientHeight);return t - o.clientHeight;
  },
      Ct = function Ct(t) {
    var r = "className";return e.SVGElement && t instanceof e.SVGElement && (t = t[r], r = "baseVal"), t[r];
  },
      Dt = function Dt(t, n, o) {
    var a = "className";if (e.SVGElement && t instanceof e.SVGElement && (t = t[a], a = "baseVal"), o === r) return t[a] = n, r;for (var i = t[a], l = 0, s = o.length; s > l; l++) {
      i = It(i).replace(It(o[l]), " ");
    }i = Ht(i);for (var c = 0, f = n.length; f > c; c++) {
    ...
    return e.frame - t.frame;
      ...
      Gt = !1,
      Kt = 0,
      Yt = []; true ? !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
    return i;
  }.call(exports, __webpack_require__, exports, module),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "undefined" != typeof module && module.exports ? module.exports = i : e.skrollr = i;
})(window, document);
...
var _skrollr = __webpack_require__(39);

var _skrollr2 = _interopRequireDefault(_skrollr);

var _isDevice = __webpack_require__(10);
...
(0, _jquery2.default)(window).on('changed.zf.mediaquery', function (event, newSize, oldSize) {
  if ((0, _isDevice.isiPad)()) {} else {
    if (Foundation.MediaQuery.atLeast('medium')) {
      (0, _jquery2.default)('.parallax-bg').css({ "opacity": "1" });
      (0, _jquery2.default)('.main-content').removeClass('animate-in');
      _skrollr2.default.init(); // skrollr.init() returns the singleton created above
    } else {
      _skrollr2.default.init().destroy(); // skrollr.init() returns the singleton created above
      (0, _jquery2.default)('.parallax-bg').css({ "opacity": "1" });
    }
  }
});
...
// CONTACT
var contact = (0, _jquery2.default)('#contactForm');

function getVisibleHeight() {
  var subtractHeight = (0, _jquery2.default)("#navBar").height() + (0, _jquery2.default)("#wpadminbar").height();
  var vH = (0, _jquery2.default)(window).height() - subtractHeight;
  return vH;
}
function setContactMargin() {
  (0, _jquery2.default)('#contactForm').css('marginTop', getVisibleHeight() * -1);
}

function setContactHeight() {
  (0, _jquery2.default)('#contactForm').height(getVisibleHeight());
}
...
(0, _jquery2.default)('a[href=\\#contact]').click(function () {
  setContactHeight();
  setContactMargin();
  // Set a class so we can see test the state of the form
  (0, _jquery2.default)('#contactForm').css('marginTop', 0);
  (0, _jquery2.default)('body').toggleClass("contact");
  (0, _jquery2.default)('.overlay').toggleClass('visible');

  // If clicked while form is hidden
  if ((0, _jquery2.default)('body').hasClass('contact')) {
    // Slidedown form
    (0, _jquery2.default)('#contactForm').addClass('contact-reveal');
    (0, _jquery2.default)('#closeForm').addClass('visible');
  } else {
    setContactMargin();
    (0, _jquery2.default)('#closeForm').removeClass('visible');
    (0, _jquery2.default)('#contactForm').removeClass('contact-reveal');
  }

  if (!(0, _jquery2.default)('body').hasClass('mobile-nav')) {
    (0, _jquery2.default)('body').toggleClass("fixed");
  }
});

// Close Form Button
(0, _jquery2.default)('#closeForm').click(function () {
  setContactMargin();
  (0, _jquery2.default)('#closeForm').removeClass('visible');
  (0, _jquery2.default)('.overlay').removeClass('visible');
  (0, _jquery2.default)('#contactForm').removeClass('contact-reveal');
  (0, _jquery2.default)('body').removeClass("contact");

  if (!(0, _jquery2.default)('body').hasClass('mobile-nav')) {
    (0, _jquery2.default)('body').removeClass("fixed");
  }
});

(0, _jquery2.default)(window).on('load', function () {
  (0, _jquery2.default)('.hs-input').each(function () {
    var input = (0, _jquery2.default)(this);
    var is_valid = input.val();
    (0, _jquery2.default)('select').parent().siblings('label').addClass("float");
    if (is_valid) {
  ...
  (0, _jquery2.default)('.hs-input').on('input', function () {
    var input = (0, _jquery2.default)(this);
    var is_valid = input.val();
    if (is_valid) {
      input.removeClass("invalid").addClass("valid");
...
(0, _jquery2.default)(function () {
  if (_foundationSites2.default.MediaQuery.atLeast('medium')) {
    if ((0, _isDevice.isiPad)()) {
      (0, _jquery2.default)('.headline').addClass('relative');
      (0, _jquery2.default)('.headline').parent().css("padding-top", "0!important");
    } else {
      (0, _jquery2.default)('.headline').parent().css("padding-top", "140px");
    }
  } else {
    (0, _jquery2.default)('.headline').parent().css("padding-top", "0");
  }
});
...
(0, _jquery2.default)('.desktop-menu li').each(function (index, element) {
  (0, _jquery2.default)(element).delay(index * 300).queue(function () {
    (0, _jquery2.default)(this).addClass('colorize');
  });
});
// wait for images
// Sequential nav color fade in
var hero = (0, _jquery2.default)("#featured-hero");
var wait = 300;
if (hero.length) {
  wait = 500;
}
...
setTimeout(function () {
  (0, _jquery2.default)("#featured-hero").addClass("animate-in");
  (0, _jquery2.default)('.overlay').removeClass('load');
  (0, _jquery2.default)('.main-content').addClass('animate-in').css({ "transform": "translate(0px,0px)" });
  (0, _jquery2.default)('.present').addClass('animate-in').css({ "transform": "translate(0px,0px)" });
  (0, _jquery2.default)('.parallax-bg').addClass('animate-in').css({ "opacity": "1" });
}, wait);

// Logo fade in
setTimeout(function () {
  (0, _jquery2.default)('.home-link').addClass('colorize');
}, 300);

setTimeout(function () {
  (0, _jquery2.default)('.main-content').removeClass('animate-in');
  (0, _jquery2.default)('.parallax-bg').removeClass('animate-in');
}, 3000);
...
(0, _jquery2.default)("#contentBody p").has("img").wrap('<div class="row expanded collapse flex-wrap" />');
(0, _jquery2.default)(".flex-wrap p").has("img").contents().unwrap();

// Find videos we want to put into a column
// iframes are placed in p tags, so let's look there
(0, _jquery2.default)("#contentBody p").has("iframe").each(function () {
  // For each p with a video we find we need to wrap it with a .video-column
  (0, _jquery2.default)(this).wrap("<div class='columns video-column' />");
  // Now we need to unwrap the p
  (0, _jquery2.default)(".video-column p").each(function () {
    (0, _jquery2.default)(this).has("iframe").contents().unwrap();
  });
  // If the previous element is an h6 we prepend it to look like a caption
  (0, _jquery2.default)(".video-column").each(function () {
    (0, _jquery2.default)(this).prev('h6').prependTo((0, _jquery2.default)(this));
  });
});

// Let's wrap wistia divs
// They aren't in P tags, so it's a bit easier.
(0, _jquery2.default)(".wistia_responsive_padding").wrap("<div class='columns video-column' />");

// Now we wrap it with a new selector, this helps us shift things around
(0, _jquery2.default)('.video-column').wrap("<div class='video-selector' />");
...
(0, _jquery2.default)('.video-selector').each(function () {
  (0, _jquery2.default)(this).nextUntil(":not(.video-selector)").appendTo((0, _jquery2.default)(this)).contents().unwrap();
});
// We wrap all the siblings in one row
(0, _jquery2.default)(".video-selector").wrap('<div class="row expanded collapse flex-wrap" />');
// And then ditch the .video-selector element
(0, _jquery2.default)(".video-selector").has(".video-column").contents().unwrap();

var rowWrap = '<div class="row align-center content"><div class="small-12 columns content-col"></div></div>';
var firstChild = (0, _jquery2.default)('#contentBody').children().first();

firstChild.not(".flex-wrap").nextUntil('.flex-wrap').addBack().wrapAll(rowWrap);

(0, _jquery2.default)(".flex-wrap").each(function (i) {
  (0, _jquery2.default)(this).nextUntil('.flex-wrap').wrapAll(rowWrap);
  // if img is in an anchor tag wrap the anchor tag in column
  (0, _jquery2.default)(this).has("a").find("a").wrap("<div class='columns'></div>");
  // if img is in flex-wrap wrap in column
  (0, _jquery2.default)(this).has("img").find("img").wrap("<div class='columns'></div>");

  // Cleaning up some possibilities
  (0, _jquery2.default)(this).has("a").find("a .columns").contents().unwrap();
  (0, _jquery2.default)(this).has("br").find("br").remove();
});

// IMG Captions
(0, _jquery2.default)(".columns img").each(function () {
  var imageCaption = (0, _jquery2.default)(this).attr("alt");
  if (imageCaption) {
    (0, _jquery2.default)("<h6>" + imageCaption + "</h6>").insertBefore(this);
  }
});
...
(0, _jquery2.default)(function () {
  ...
  //   $(this).addClass("gif");
  // });
  (0, _jquery2.default)('.gif').hover(function () {
    var src = (0, _jquery2.default)(this).attr("src");
    (0, _jquery2.default)(this).attr("src", src.replace(/\.jpg$/i, ".gif"));
  }, function () {
    var src = (0, _jquery2.default)(this).attr("src");
    (0, _jquery2.default)(this).attr("src", src.replace(/\.gif$/i, ".jpg"));
  });
});
...
function getVisibleHeightNav() {
  var subtractHeight = (0, _jquery2.default)("#navBar").height() + (0, _jquery2.default)("#wpadminbar").height() + (0, _jquery2.default)("#mobileBoxButton").height();
  var vH = (0, _jquery2.default)(window).height() - subtractHeight;
  return vH;
}

function setMobileNavHeight() {
  (0, _jquery2.default)('#mobileMenu').height(getVisibleHeightNav());
}
...
(0, _jquery2.default)('#mobileToggle').click(function () {
  (0, _jquery2.default)(this).toggleClass('open');
  (0, _jquery2.default)('#mobileMenu').slideToggle("slow", function () {});
  (0, _jquery2.default)('body').toggleClass("fixed mobile-nav");
  (0, _jquery2.default)('#mobileMenu li').each(function (index, element) {
    (0, _jquery2.default)(element).delay(index * 150).queue(function () {
      (0, _jquery2.default)(this).addClass('fade-in');
    });
  });
  if ((0, _jquery2.default)('body').hasClass('contact')) {
    setContactMargin();
...
(0, _jquery2.default)(window).on('changed.zf.mediaquery', function (event, newSize, oldSize) {
  if (newSize == "medium") {
    if (oldSize == "small") {
      (0, _jquery2.default)('#mobileMenu').slideUp();
      if ((0, _jquery2.default)('body').hasClass("mobile-nav")) {
        (0, _jquery2.default)(this).removeClass("fixed mobile-nav");
      }
    }
  }
  ...
  if (oldSize == "medium") {
    if (newSize == "small") {
      (0, _jquery2.default)('.sticky-container').css('height', 'auto');
    }
  }
});
...
(0, _jquery2.default)(window).scroll(function (event) {
  ...
  if (st > lastScrollTop) {
    if (st > 150) {
      (0, _jquery2.default)("#navigationContainer").addClass('peek-hide');
    }
  } else {
...
(0, _jquery2.default)('.hover-indicator').each(function () {
    var width = (0, _jquery2.default)(this).next().children("h3").width();
    (0, _jquery2.default)(this).width(width + 40);
});
(0, _jquery2.default)(window).resize(function () {
    (0, _jquery2.default)('.hover-indicator').each(function () {
        var width = (0, _jquery2.default)(this).next().children("h3").width();
...
(0, _jquery2.default)(".permalink").hover(function () {
    (0, _jquery2.default)(this).find('.hover-indicator').toggleClass("hover");
});
...
(0, _jquery2.default)(window).bind(' load resize orientationChange ', function () {
  var footer = (0, _jquery2.default)("#footer-container");
...
(0, _jquery2.default)("#featureVideo").fadeOut();

// Playback for Archive Page
function archivePlay(perma) {
  (0, _jquery2.default)("body").addClass("video-fixed");
  (0, _jquery2.default)("#featured-hero").addClass('video-reveal').removeClass('hidden');
  ...
  setTimeout(function () {
    (0, _jquery2.default)("#featureVideo").fadeIn('slow');
  }, 500);
...
(0, _jquery2.default)(".play").click(function () {
  ...
  if ((0, _jquery2.default)(this).hasClass('reel')) {
    (0, _jquery2.default)('#seeProject').parent().hide();
  } else {
    (0, _jquery2.default)('#seeProject').parent().show();
  }
  var permalink = (0, _jquery2.default)(this).attr("data-permalink");
  archivePlay(permalink);
});

if ((0, _isDevice.isiPad)() || (0, _isDevice.isiPhone)()) {
  (0, _jquery2.default)('#featured-hero').addClass('device');

  (0, _jquery2.default)(".iplay").bind("touchstart click", function () {
    var permalink = (0, _jquery2.default)(this).closest('a').attr("data-permalink");
    archivePlay(permalink);
  });
}

//Playback for Single Page
(0, _jquery2.default)(".feature-play").click(function () {

  (0, _jquery2.default)("body").addClass("video-fixed video-single");
  (0, _jquery2.default)("#featured-hero").addClass("video-reveal click-to-close");
  (0, _jquery2.default)(".feature-overlay").addClass("animate-in");
  (0, _jquery2.default)("#featureVideo").fadeIn('slow');
  (0, _jquery2.default)('#navBar').addClass('push-up');
  (0, _jquery2.default)('.feature-play').addClass('blow-up');
  (0, _jquery2.default)('.main-content').addClass('push-down');
});

(0, _jquery2.default)(document).mouseup(function (e) {
  var container = (0, _jquery2.default)(".wistia_embed");

  if ((0, _jquery2.default)('body').hasClass('video-fixed')) {
    if (!container.is(e.target) && container.has(e.target).length === 0) {
      (0, _jquery2.default)("body").removeClass("video-fixed");
      (0, _jquery2.default)("#featureVideo").hide();

      if ((0, _jquery2.default)('body').hasClass('video-single')) {
        (0, _jquery2.default)("#featured-hero").removeClass("video-reveal click-to-close");
        (0, _jquery2.default)(".feature-overlay").removeClass("animate-in");
        (0, _jquery2.default)('#navBar').removeClass('push-up');
        (0, _jquery2.default)('.feature-play').removeClass('blow-up');
        (0, _jquery2.default)('.main-content').removeClass('push-down');
      } else if ((0, _jquery2.default)('body').hasClass('single-example')) {
        (0, _jquery2.default)("#featured-hero").removeClass("video-reveal click-to-close");
        (0, _jquery2.default)(".feature-overlay").removeClass("animate-in");
        (0, _jquery2.default)('#navBar').removeClass('push-up');
        (0, _jquery2.default)('.feature-play').removeClass('blow-up');
        ...
        (0, _jquery2.default)("#featured-hero").removeClass('video-reveal').addClass('hidden');
        (0, _jquery2.default)(".feature-overlay").removeClass("animate-in");
        (0, _jquery2.default)('#navBar').removeClass('push-up');
        (0, _jquery2.default)('.main-content').removeClass('push-down');
      }
...
(0, _jquery2.default)(".permalink").hover(function () {
  (0, _jquery2.default)(this).siblings(".post-block").find(".permalink-overlay").toggleClass("show");
});
